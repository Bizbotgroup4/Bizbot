...
const Selection = ({ label, selected, setSelected, options, disabled }) => {
  return (
    <div>
      <Listbox disabled={disabled} value={selected} onChange={setSelected}>
        ...
        <div className="relative mt-2">
          <ListboxButton className="relative w-full cursor-default rounded-md bg-white py-2 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 sm:text-sm sm:leading-6">
